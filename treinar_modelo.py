...
for arquivo in imagens:
    ...
    #Paronizar as letras em 20px 20px 
...
#separar dados de treino e de teste --> X=dados, Y=rotulos
(X_train, X_teste, Y_train, Y_teste) = train_test_split(dados, rotulos, test_size=0.25, random_state=0)

#Converter Letras em Numeros da lista rotulos
...
#Camada de Saida
modelo.add(Dense(26,activation="softmax"))# 26--> Numero de saidas, de acordo com as letras
...
modelo.fit(X_train,Y_train, validation_data=(X_teste,Y_teste), batch_size=26, epochs=10, verbose=1)

#Salvar o Modelo Treinado
modelo.save("IA_treinado.dat")
